...
import LoveBuild from '../Images/lovebuild.png'
...
export default class Contenet extends Component {
    render() {
        return (
            <div>
                ...
                <div className="w3-content w3-padding" style={{maxWidth: '1564px'}}>
                    ...
                    <div className="w3-col l3 m6 w3-margin-bottom">
                        <div className="w3-display-container">
                        <div className="w3-display-topleft w3-black w3-padding">Summer House</div>
                        <img src={House2} alt="House" style={{width: '99%'}} />
                        </div>
                    </div>
                    <div className="w3-col l3 m6 w3-margin-bottom">
                        <div className="w3-display-container">
                        <div className="w3-display-topleft w3-black w3-padding">Brick House</div>
                        <img src={House5} alt="House" style={{width: '99%'}} />
                        </div>
                    </div>
                    <div className="w3-col l3 m6 w3-margin-bottom">
                        <div className="w3-display-container">
                        <div className="w3-display-topleft w3-black w3-padding">Renovated</div>
                        <img src={House6} alt="House" style={{width: '99%'}} />
                        </div>
                    </div>
                    <div className="w3-col l3 m6 w3-margin-bottom">
                        <div className="w3-display-container">
                    ...
                    <img src={LoveBuild}  style={{width: '100%',height:'auto'}} />
                    </div>
                    {/* End page content */}
                </div>
                        </div>
